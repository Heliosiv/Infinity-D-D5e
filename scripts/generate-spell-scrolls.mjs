...
function buildUnidentifiedDescription(id) {
  return `<section class="infinity-item-description infinity-item-description--unidentified" data-schema="infinity-dnd5e-description-state-v1" data-identification-state="unidentified" data-item-id="${escapeHtml(id)}"><p><em>A sealed scroll awaiting identification.</em></p><p>This sealed scroll is described by paper stock, ink, and binding. Its practical use is apparent, but exact value and spell formula still need inspection.</p><ul class="infinity-item-state-list"><li>Visible form: Sealed Scroll</li><li>Inspection cues: paper stock, ink, and binding</li><li>Identification state: Unidentified</li></ul></section>`;
}
