...
function resourceManagerCustomEnvironmentContext() {
  ...
  return {
    ...
    customEnvironmentCount: 3,
    canExportEnvironments: true,
...
function downtimeWorkspaceProjectEditorContext() {
  ...
  return downtimeWorkspaceBaseContext({
    ...
    rewardBasisOptions: [
      { id: "allocation", label: "Once per allocation", selected: true },
      { id: "workday", label: "Per 8 productive hours", selected: false },
    ],
    projectEditor: {
      prerequisites: "",
      scopeOptions: [],
