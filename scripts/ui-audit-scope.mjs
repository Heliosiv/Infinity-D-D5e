...
const TARGETS = Object.freeze([
  ...
  },
  {
    ...
    fixtures: [
      ...
      "merchant-editor-pricing",
      "merchant-editor-bargaining",
      "merchant-editor-charm",
      "merchant-editor-stock",
      "merchant-editor-generate",
      "merchant-editor-buys",
      "merchant-editor-access",
      "merchant-editor-sessions",
      "merchant-editor-manage",
    ],
